...
do more elaborate what is this 
requierements
"""
...
#This decides whether to scale the atom of a given name (atname) in a residue with name resname or not and returnt True or False
...
#check if procssed file was genereted or no!!!
...
with open(parmed_scale_input,"w") as parmedIn:
	...
	#rename this shit!!!!!atom_properties_tuple forex PYCHARM
	pat_tuple=list(present_atom_types.items())	#list of [atomids, LJradius, LJepsilon] for atomtypes
